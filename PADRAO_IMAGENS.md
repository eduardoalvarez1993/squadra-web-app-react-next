...
- Para Recursos/Videos, o conceito aprovado e uma base 3D flat premium com player principal e cards de video ao fundo, sem texto. O elemento animado separado e uma bobina/rolo de filme premium em PNG/WebP transparente, girando por CSS no centro do player.
- Para Verificando Credenciais, o conceito aprovado e uma digital em moeda/token redondo 3D flat premium, sem escudo, sem cadeado e sem texto. A animacao e um anel luminoso CSS que contorna a moeda, fecha o circulo e pulsa para sugerir validacao de sessao/permissao. O cracha corporativo anterior pode permanecer como backup, mas nao deve ser o asset ativo.
